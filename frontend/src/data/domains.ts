...
export const LANGUAGE_OPTIONS = [
  'Shqip', 'Gjermanisht', 'Anglisht', 'Serbisht', 'Turqisht', 'Frëngjisht',
] as const
...
export function domainRequires(domain: DomainDefinition | null | undefined, requirement: DomainRequirement) {
